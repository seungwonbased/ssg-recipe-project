"""
KAMIS 오픈 API 중 DailySalesList API의 응답에 대응하는 모델을 정의한 모듈
...
class PriceResponse:
    ...
    #: 품목 구분; `product_cls_code` 값을 통해 만들어짐
    ...
    def __post_init__(
        ...
        object.__setattr__(self, "product_class", ProductClass(product_cls_code))
        object.__setattr__(
